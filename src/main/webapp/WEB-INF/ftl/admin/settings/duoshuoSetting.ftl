...
<div class="container body-container">
	...
	<div class="row">
		...
		<div class="span9">
			<section>
				<h4>多说评论设置</h4>
				<form id="signs-form" class="form-horizontal" action="${contextPath}/admin/settings/duoshuoSetting.json" method="post">
					<div class="control-group">
						<label class="control-label" for="key">多说域名：</label>
						<div class="controls">
						<input type="text" name="key" value="${cfg.duoshuoKey }" />
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
...
$("#nav-settings-duoshuoSetting").addClass("active");
$('#signs-form').ajaxForm({
	//dataType:"json",
